...
5. Você precisará de ETH, para realizar transações. Para conseguir fundos crie uma carteira em seguida utilize um faucet: `https://cloud.google.com/application/web3/faucet/ethereum/sepolia`
